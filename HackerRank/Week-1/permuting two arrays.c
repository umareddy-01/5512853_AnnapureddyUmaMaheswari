 ...
 *
 */
 void selec_sort_ascen(int* arr,int n){
    for(int i=0;i<n-1;i++){
        int minimum_index=i;
        for(int j=i+1;j<n;j++){
 ...
 void selec_sort_descn(int* arr,int n){
    for(int i=0;i<n-1;i++){
        int maximum_index=i;
        for(int j=i+1;j<n;j++){
        ...
        if(maximum_index!=i){
            int temp=arr[i];
            arr[i]=arr[maximum_index];
            arr[maximum_index]=temp;
        }
    }
 }
 
char* twoArrays(int k, int A_count, int* A, int B_count, int* B) {
    selec_sort_ascen(A,A_count);
    selec_sort_descn(B,B_count);
